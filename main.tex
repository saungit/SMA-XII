...
\includegraphics[width = 6cm, height= 4cm]{Pictures/Gb 1_diana.png}

Nyatakan data di atas dalam bentuk diagram garis.
Penyelesaian
Jika digambar dengan menggunakan diagram garis adalah sebagai berikut.

\includegraphics[width = 6cm, height= 4cm]{Pictures/Gb 2_diana.png}
...
\includegraphics[width = 6cm, height= 4cm]{Pictures/Gb 3_diana.png}

Buatlah diagram garis untuk data tersebut.

Penyelesaian

\includegraphics[width = 6cm, height= 4cm]{Pictures/Gb 4_diana.png}
...
\includegraphics[width = 6cm, height= 4cm]{Pictures/Gb 5_diana.png}
...
\includegraphics[width = 6cm, height= 4cm]{Pictures/Gb 6_diana.png}
